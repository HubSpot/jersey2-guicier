...
public class SupplierInstanceBindingTest {
  ...
  public void testInstanceFactory() {
    ...
    BindingTestHelper.bind(
      injectionManager,
      binder -> binder.bindFactory(supplier).to(Integer.class)
    );

    assertEquals((Integer) 3, injectionManager.getInstance(Integer.class));
    assertEquals((Integer) 4, injectionManager.getInstance(Integer.class));
  }
  ...
  public void testSupplierBeanNamed() {
    BindingTestHelper.bind(
      ...
      binder -> {
        binder
          .bindFactory(new TestSuppliers.TestSupplier())
          .named(TestSuppliers.TEST)
          .to(String.class);
        binder
          .bindFactory(new TestSuppliers.OtherTestSupplier())
